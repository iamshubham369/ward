...
const TransparencyArchive = () => {
    ...
    const rtiRecords = [
        { id: 'RTI-2025-001', subject: 'Ward 14 Road Maintenance Budget Allocation', status: 'Disclosed' },
        { id: 'RTI-2025-004', subject: 'Sector 5 Water Pipeline Contractor Details', status: 'Disclosed' },
        { id: 'RTI-2025-009', subject: 'Ward Office Attendance Logs — Jun 2025', status: 'Under Review' },
    ];
        ...
        <section id="archive" className="bg-stone-100 dark:bg-navy-950 py-16 md:py-24 border-t border-stone-200 dark:border-navy-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="reveal visible mb-12">
                    <span className="font-mono text-[10px] tracking-[0.3em] uppercase text-saffron-600 font-black mb-2 block italic">Transparency Portal</span>
                    <h2 className="font-display font-black text-3xl sm:text-4xl md:text-5xl text-navy-900 dark:text-stone-50 leading-tight flex items-center gap-4">
                        Civic <span className="text-saffron-500 italic">Archive</span> <FileStack className="w-8 h-8 text-saffron-500" />
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 reveal visible">
                    <div className="bg-white dark:bg-navy-900 rounded-3xl border border-stone-200 dark:border-navy-700 p-8 shadow-xl group">
                        <h3 className="text-xs font-mono font-black text-navy-800 dark:text-stone-300 uppercase tracking-widest mb-6 flex items-center justify-between">RTI Public Disclosure Log <Table className="w-4 h-4 text-saffron-500" /></h3>
                    ...
                    <div className="bg-navy-900 rounded-3xl p-10 text-stone-50 relative overflow-hidden group border border-navy-800">
                        <div className="relative z-10">
                            ...
                            <h3 className="font-display font-black text-3xl mb-4 tracking-tight uppercase">Request Information Protocol</h3>
                            <p className="text-xs text-stone-400 font-bold uppercase tracking-widest mb-10 leading-relaxed max-w-[280px]">
                                Exercise your right to know. File a digital RTI request to the Ward 14 Intelligence Node.
                            </p>
